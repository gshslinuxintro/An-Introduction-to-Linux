...
\title{경기과학고등학교 연구용 서버\\사용 및 관리 설명서}  % use \\ here otherwise you get a justified title
                                                    ...
                                                    % words in lower case)
\tagline{version 1.02}                     % tag line
\author{리눅스 사용자 협회}                           % your name
\authorID{GSHS}                           % your University Identifier
\supervisor{gs19007}                             % your supervisor(s) name - no . in Dr
\cosupervisor{gs19032}                               % your cosupervisor(s) name - no . in Dr ** OPTIONAL ** 
...
\degreedate{2021. 5. 15.}                        % when did you submit -- officially after your corrections !
...
\mainmatter 
    ...
    \input{chap2/connection_main}
    \input{chap3/command_main}
    \input{chap4/environments_main}
    \input{chap5/other_main}
    \input{chap6/admin_main}
    \appendix
